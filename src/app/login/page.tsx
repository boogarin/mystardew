                    ...
                    <ContainerSV>
                        ...
                        <div className="px-4 py-2 flex-col">
                            ...
                            <Link href={'/login/password-recovery'}>
                                <p className="font-semibold text-right text-[14px] text-[#663300] mt-1"><FormattedMessage id="login_forgot"/></p>
                            </Link>
                            <div className="mt-5">
                            ...
                            <p className="mt-4 text-center text-[#663300]"><FormattedMessage id="login_signup"/></p>
                            <Link href={'/sign-up'}><p className="font-semibold text-center text-[#663300]"><FormattedMessage id="login_signup2"/></p></Link>
                        </div>
                    </ContainerSV>
                </div>
